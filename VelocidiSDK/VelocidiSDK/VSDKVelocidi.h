...
/**
  ...
  This method assumes that the function `.start` as been called before calling
  this method. Otherwise, it will throw a NSInternalInconsistencyException.
  @returns shared single instance of the class VSDKVelocidi
 */
+ (instancetype)sharedInstance;

/**
  Method that takes the provided configuration and properly initializes the
  Velocidi SDK according to the settings of said configuration.
