...
- (void)testVelocidiInstanceSuccess {
  VSDKConfig *config =
      [[VSDKConfig alloc] initWithTrackingBaseUrl:@"https://tr.testdomain.com:8080"
...
- (void)testCreateConfigFromBaseURLAndKeepPath {
  VSDKConfig *config = [[VSDKConfig alloc] initWithTrackingBaseUrl:@"https://tr.domain.com/v1"
